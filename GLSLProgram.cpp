...
void GLSLProgram::setMatrix(const glm::mat4 &matrix, const GLenum &type) {
    switch(type) {
        case GL_PROJECTION_MATRIX:
            glUniformMatrix4fv(20, 1, GL_FALSE, glm::value_ptr(matrix));
            break;
        case GL_MODELVIEW_MATRIX:
            glUniformMatrix4fv(21, 1, GL_FALSE, glm::value_ptr(matrix));
            break;
    }
}
